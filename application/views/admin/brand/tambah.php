...
// Form buka 
echo form_open_multipart(base_url('admin/brand'));
?>

<div class="col-md-12">
<div class="form-group">
<label>Nama Brand</label>
<input type="text" name="nama_brand" class="form-control" placeholder="Nama Brand" value="<?php echo set_value('nama_brand') ?>" required>
</div>
</div>
