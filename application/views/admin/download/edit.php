...
<select name="jenis_download" class="form-control">
	...
	<?php if($download->jenis_download=="Homepage") { echo "selected"; } ?>
...
<textarea name="isi" class="form-control konten" placeholder="Isi download"><?php echo $download->isi ?></textarea>
</div>
