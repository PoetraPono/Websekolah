...
<div class="col-md-12 lead text-center"><i class="fa fa-github fa-3x picker-target"></i></div>
	<div class="form-group">
    	<label>Icon Isi quote 1 (Current icon: <i class="fa <?php echo $site->pesan_1 ?> fa-2x"></i> <?php echo $site->pesan_1 ?>)</label>
       	<input class="form-control icp icp-auto" type="text" name="pesan_1" value="<?php echo $site->pesan_1 ?>" />
        
    </div>
    
    <div class="form-group">
    	<label>Icon Isi quote 2 (Current icon: <i class="fa <?php echo $site->pesan_2 ?> fa-2x"></i> <?php echo $site->pesan_2 ?>)</label>
       	<input class="form-control icp icp-auto" type="text" name="pesan_2" value="<?php echo $site->pesan_2 ?>" />
    </div>
    
    <div class="form-group">
    	<label>Icon Isi quote 3 (Current icon: <i class="fa <?php echo $site->pesan_3 ?> fa-2x"></i> <?php echo $site->pesan_3 ?>)</label>
       	<input class="form-control icp icp-auto" type="text" name="pesan_3" value="<?php echo $site->pesan_3 ?>" />
    </div>
    
    <div class="form-group">
    	<label>Icon Isi quote 4 (Current icon: <i class="fa <?php echo $site->pesan_4 ?> fa-2x"></i> <?php echo $site->pesan_4 ?>)</label>
      	<input class="form-control icp icp-auto" type="text" name="pesan_4" value="<?php echo $site->pesan_4 ?>" />
    </div>
    
    <div class="form-group">
    	<label>Icon Isi quote 5 (Current icon: <i class="fa <?php echo $site->pesan_5 ?> fa-2x"></i> <?php echo $site->pesan_5 ?>)</label>
      	<input class="form-control icp icp-auto" type="text" name="pesan_5" value="<?php echo $site->pesan_5 ?>" />
    </div>
    
    <div class="form-group">
    	<label>Icon Isi quote 6 (Current icon: <i class="fa <?php echo $site->pesan_6 ?> fa-2x"></i> <?php echo $site->pesan_6 ?>)</label>
...
<div class="col-md-12">
	<input type="submit" name="submit" value="Save Configuration" class="btn btn-primary btn-sm">
