...
// Form open
echo form_open_multipart(base_url('admin/eskul/tambah'));
?>

<div class="col-md-6">
  <div class="form-group form-group-lg">
  <label>Nama Eskul</label>
    <input type="text" name="nama_eskul" class="form-control" placeholder="Nama Eskul" required="required" value="<?php echo set_value('nama_eskul') ?>">
  </div>
</div>
<div class="col-md-6">
