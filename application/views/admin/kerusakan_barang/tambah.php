...
// Form buka 
echo form_open_multipart(base_url('admin/kerusakan_barang/barang/'.$barang->id_barang));
?>
<div class="col-md-8">
<div class="form-group">
<label>Nama/judul Kerusakan</label>
<input type="text" name="nama_kerusakan" class="form-control" placeholder="Nama/judul Kerusakan" value="<?php echo set_value('nama_kerusakan') ?>" required>
</div>
</div>
...
<select name="id_jenis_kerusakan" class="form-control">
	...
	<option value="<?php echo $jenis_kerusakan->id_jenis_kerusakan ?>"><?php echo $jenis_kerusakan->nama_jenis_kerusakan ?></option>
	<?php } ?>
</select>
</div>
</div>
...
<input type="text" name="tanggal_rusak" class="form-control datepicker" placeholder="YYYY-MM-DD" value="<?php echo set_value('tanggal_rusak') ?>">
</div>
</div>
...
<input type="text" name="tanggal_perbaikan" class="form-control datepicker" placeholder="YYYY-MM-DD" value="<?php echo set_value('tanggal_perbaikan') ?>">
</div>
</div>
...
<input type="text" name="tanggal_selesai" class="form-control datepicker" placeholder="YYYY-MM-DD" value="<?php echo set_value('tanggal_selesai') ?>">
</div>
</div>
...
<input type="number" name="biaya_perbaikan" class="form-control" placeholder="Biaya perbaikan" value="<?php echo set_value('biaya_perbaikan') ?>">
</div>
</div>
...
<script>
	$("#id_client").chained("#dilaporkan_oleh");
</script>